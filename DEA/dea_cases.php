           ...
           <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-4 white-text text-center">
                    <h3><strong>Enter Case Details</strong></h3>
                    
                    <h2>Select by Case ID</h2><br></strong>
              <form action="deacase.php" method="POST">
    <h5>Case ID :</h5>
    <input type="text" class="form-control" name="caseid" id="crid" aria-describedby="crid" placeholder="Enter Case ID">
    <br>
  <input type="submit" value="Submit" class="btn btn-primary">
</form>
<h2>Select by Drugs Involved</h2><br></strong>
<form action="deacase.php" method="POST">
